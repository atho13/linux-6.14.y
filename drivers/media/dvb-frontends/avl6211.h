...
struct avl6211_config {
	...
	u8 mpeg_format;    /* 0: Default TS stream, 1: TS stream + parity */
	...
	u8 tuner_spectrum; /* 0: Spectrum normal, 1: Spectrum inverted */

	u8 use_lnb_pin59;  /* Control 13/18V over demod GPIO pin59 */
	u8 use_lnb_pin60;  /* Control 13/18V over demod GPIO pin60 */

	int (*set_external_vol_gpio)(int *demod_id,
				     int on); /* External 13/18V control */
};

extern struct dvb_frontend *
avl6211_attach(struct i2c_adapter *i2c, struct avl6211_config *config, int id);
