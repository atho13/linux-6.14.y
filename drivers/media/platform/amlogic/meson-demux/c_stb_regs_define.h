...
#define PARSER_SUB_START_PTR_BASE aml_stb_get_base(ID_PARSER_SUB_START_PTR_BASE)
...
#define DEMUX_INPUT_TIMEOUT (STB_CBUS_BASE + DEMUX_1_OFFSET + 0x47) /* 0x1647*/
...
#define DEMUX_PACKET_COUNT_C (STB_CBUS_BASE + DEMUX_1_OFFSET + 0x48) /* 0x1648*/
...
#define DEMUX_PACKET_COUNT (STB_CBUS_BASE + DEMUX_1_OFFSET + 0x49) /* 0x1649*/
#define DEMUX_PACKET_COUNT_2 (STB_CBUS_BASE + DEMUX_2_OFFSET + 0x49) /* 0x1699*/
#define DEMUX_PACKET_COUNT_3 (STB_CBUS_BASE + DEMUX_3_OFFSET + 0x49) /* 0x16e9*/

/* bit[31:0] channel_record_enable*/
#define DEMUX_CHAN_RECORD_EN (STB_CBUS_BASE + DEMUX_1_OFFSET + 0x4a) /* 0x164a*/
...
#define DEMUX_SMALL_SEC_CTL (STB_CBUS_BASE + DEMUX_1_OFFSET + 0x4c) /* 0x164c*/
...
#define DEMUX_SMALL_SEC_ADDR (STB_CBUS_BASE + DEMUX_1_OFFSET + 0x4d) /* 0x164d*/
