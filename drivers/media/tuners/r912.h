...
//----------------------------------------------------------//
#if 1
typedef enum _R912_ErrCode { RT_Success = true, RT_Fail = false } R912_ErrCode;
#endif
...
typedef enum _R912_RF_Gain_TYPE { RF_AUTO = 0, RF_MANUAL } R912_RF_Gain_TYPE;
...
extern struct dvb_frontend *r912_attach(struct dvb_frontend *fe,
					struct r912_config *cfg,
					struct i2c_adapter *i2c);
#endif
